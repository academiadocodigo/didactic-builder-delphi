...
Type
  TBrowserVCLWebBrowser = class(TInterfacedObject, iModelBrowser)
  private
...
{$IF RTLVERSION > 22 }
procedure TBrowserVCLWebBrowser.BeforeNavigate(ASender: TObject;
...
function TBrowserVCLWebBrowser.ConvertString(aValue: String): String;
var
  rbs : RawByteString;
begin
...
constructor TBrowserVCLWebBrowser.Create(Value: TObject);
begin
...
procedure TBrowserVCLWebBrowser.DefineIEVersion;
const
...
destructor TBrowserVCLWebBrowser.Destroy;
begin

  inherited;
end;

procedure TBrowserVCLWebBrowser.ExecuteScript(Value: iModelJSCommand);
var
  Doc : IHTMLDocument2;
...
procedure TBrowserVCLWebBrowser.ExecuteScriptCallback(
...
function TBrowserVCLWebBrowser.ExecuteScriptResult(Value: iModelJSCommand): string;
var
  Doc : IHTMLDocument2;
  body : IHTMLElement2;
...
function TBrowserVCLWebBrowser.Generated(FHTML: string): iModelBrowser;
begin
  Result := Self;
...
procedure TBrowserVCLWebBrowser.HtmlBrowserGenerated(const HTMLCode: string);
var
  sl : TStringList;
  ms : TMemoryStream;
begin
...
class function TBrowserVCLWebBrowser.New(Value: TObject): iModelBrowser;
begin
